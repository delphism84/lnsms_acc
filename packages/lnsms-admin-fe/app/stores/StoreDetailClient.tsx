...
export default function StoreDetailClient({ agentId, storeId }: { agentId: string; storeId: string }) {
  ...
  const agentListHref = isStoreSite ? platformPath() : `/stores/${agentId}`;
  const menuBasePath = isStoreSite ? storeSiteBase(agentId, storeId) : `/stores/${agentId}/${storeId}`;
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setEqidForm({
                          eqid: eqid.eqid,
                          displayTime: eqid.displayTime,
                          enabled: eqid.enabled,
                        });
                        setError(null);
                        setShowEqidModal(true);
                      }}
