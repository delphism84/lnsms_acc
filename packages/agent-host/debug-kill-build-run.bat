...
echo [1/4] Kill LNSMS ports (27017, 40000, 63001, 58000) ...
set "ROOT=%~dp0..\..\"
powershell -NoProfile -ExecutionPolicy Bypass -File "%ROOT%scripts\kill-lnsms-ports.ps1"
if errorlevel 1 (
  echo WARNING: kill-lnsms-ports.ps1 failed — continuing
)

echo [2/4] Kill existing %EXE% ...
